...
# Optional: Load default file path (for local/development use)
default_file_path = "/mnt/data/car.csv"
use_default = st.checkbox("Use default dataset (car.csv) from uploaded path")
...
if use_default:
    ...
    if uploaded_file is not None:
        ...
        st.warning("⚠ Please upload the car.csv file or select 'Use default dataset' to proceed.")
        st.stop()
